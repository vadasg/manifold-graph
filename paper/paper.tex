...
\begin{figure}
    \begin{center}
    {
		...
		\fbox{\includegraphics[width=0.75\linewidth]{figures/split_statistics.png}}
    }
	...
	\end{tabular}
    \end{center}
    \caption{Number of connected positively curved combinatorial 3-manifolds by topology and diameter, displayed graphically (above) and in table form (below)}
...
\begin{figure}
    \begin{center}
    {
	    \setlength\fboxsep{10pt}
		\setlength\fboxrule{0pt}
		\fbox{\includegraphics[width=0.75\linewidth]{figures/split_edge_diameters.png}}
    }
	\begin{tabular} {| r | r | r | r | r | r | r |}	
		\hline
	...
	\end{tabular}
    \end{center}
    \caption{Number of connected positively curved combinatorial 3-manifolds by topology and edge-diameter, displayed graphically (above) and in table form (below)}
